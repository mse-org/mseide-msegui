...
uses
  Classes, mclasses,SysUtils, mseFPImage, mse_JPEGLib_del, mseFPReadJPEG,
  mse_JcAPIstd_del, mse_JcAPImin_del, mse_JDataDst_del, mse_JcParam_del, mse_JError_del;
...
var
  ...
  begin
    ...
    FInfo.err := mse_jerror_del.jpeg_std_error(FError);
