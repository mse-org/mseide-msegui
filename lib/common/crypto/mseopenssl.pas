...
// EVP_PKEY = SslPtr;
 ...
 TPWCallbackFunction = function(buffer: PCharacter; length: cint; verify: cint; data: pointer): cint; cdecl;
...
//  SSL_CTX_set_cipher_list: function(arg0: PSSL_CTX; var str: String):cint; cdecl;
...
//  SSL_CTX_use_PrivateKey_file: function(ctx: PSSL_CTX; const _file: String; _type: cint):cint; cdecl;
...
//  function SSL_CTX_LoadVerifyLocations(ctx: PSSL_CTX; const CAfile: PChar; const CApath: PChar):cint; cdecl;
...
const
 ...
 funcsutil: array[0..23] of funcinfoty = (
