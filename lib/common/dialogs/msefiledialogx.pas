...
uses
 SysUtils,Classes,{$ifdef unix}baseunix,{$endif}Math,mclasses,mseclasses,
 mseforms,msewidgets,msegrids,mselistbrowser,mseedit,mseglob,mseguiglob,
 ...
 msemenuwidgets,msescrollbar,msedragglob,mserichstring,msetimer,
...
////////////////////////////////////
  fcontroller   := tfiledialogxcontroller.Create({?nil?}aowner AS tmsecomponent);
////////////////////////////////////
  inherited;
end;
