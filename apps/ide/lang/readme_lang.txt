...
To add a new language, use as layout of  '/mseide_empty.po' and fill all the msgstr "" with the translation.

When done, rename the file with the code of your language after the "_" , like 'mseide_xz.po'.
...
When your .po file is ready, just add it into '/mseide/lang/' folder.
