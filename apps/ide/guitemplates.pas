...
const
 sysenvvalues: array[envvarty] of argumentdefty =
  ((kind: ak_pararg; name: '-macrodef'; anames: nil; flags: []),
   ...
   (kind: ak_envvar; name: 'FPCDIR'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'FPCLIBDIR'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'MSEDIR'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'MSELIBDIR'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'SYNTAXDEFDIR'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'TEMPLATEDIR'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'COMPSTOREDIR'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'COMPILER'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'DEBUGGER'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'EXEEXT'; anames: nil; flags: []),
   (kind: ak_envvar; name: 'TARGET'; anames: nil; flags: []),
